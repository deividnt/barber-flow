  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-lg p-1 transition-all duration-200 focus:outline-none"
        style={{ color: '#52525B' }}
        onMouseEnter={e => {
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn('text-sm', className)} style={{ color: '#52525B' }} {...props} />
))
